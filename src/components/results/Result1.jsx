    ...
    return (
        <div className="result">
            ...
            <div className="result__container-two">
                ...
                <p className="result__text text-italic text-left ">You’d better be determined and courageous but not very pushy. Don’t confess your love right off the bat. Just talk to her sincerely and send her a couple of your best photos. That will be a good start.</p>
            </div>

            <img alt='' src={tree} className="result__tree" />
            <p className="result__text">She is passionate about active sport and always ready for a new challenge</p>
