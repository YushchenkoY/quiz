...
import leo from '../../img/zodiac/leo.png'
    ...
    return (
        <div className="result">
            ...
            <div className="result__container">
                ...
                <div className="result__zodiac-wrapper">
                    <div className="result__zodiac">
                        <img src={leo} alt="" className="result__zodiac-img" />
                        <p className="result__zodiac-text">Leo</p>
                    </div>
                    <div className="result__zodiac">
            ...
            <div className="result__wrapper">
                <h2 className="result__title">She is an extrovert,</h2>
                <p className="result__text">so people love her, and she gets along with them. She is eager to live this life to the fullest, and a caring partner is just what she needs. No doubt, this woman is a hot fantasy.</p>
